...
"}")
        self.tableWidget.setStyleSheet("""
         ...
         """)
        self.tableWidget.setColumnWidth(0, 100)  # Define a largura da primeira coluna
        self.tableWidget.setColumnWidth(1, 100)  # Define a largura da segunda coluna
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_13.setText(QCoreApplication.translate("Form", u"Consulta", None))
        self.pushButton_14.setText(QCoreApplication.translate("Form", u"Cadastrar", None))
